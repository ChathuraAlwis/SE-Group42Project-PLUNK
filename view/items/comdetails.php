  ...
  <body>
        <div class="main" >
                    ...
                    <?php
                        ...
                        // }
                        $itemTable->show("SELECT Company AS 'Company Name', DistributorName AS 'Distributor Name', PhoneNo AS 'Phone No' FROM plunk.company WHERE Remove='No'",'../items/additems');
                      ?> 
                    </div>
