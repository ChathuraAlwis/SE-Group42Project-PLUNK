        ...
        <div class="main" >
            <div class="coverheader">
              ...
              <div class="tableheader">
                    ...
                    <h2>Confirmed Restaurant Booking </h2>
              </div>
            </div><br>
            <div class="covertable">
                <div class="table">
                    <div class="upperbar">
                        ...
                        <form class="searchbar" action="restaurentconfrimedbooking.php" method="post">
                    ...
                    <div class="detailtable">
                      <?php
                        ...
                        if(isset($_POST['searchname'])){
                          echo'<iframe src="restaurantconfirmtable.php?CustomerName='.$_POST['clubsearch'].'" name="searchinfo" class="staff"></iframe>';
                        }
                        else{
                          echo '<iframe src="restaurantconfirmtable.php" name="searchinfo" class="staff"></iframe>';
                        }
