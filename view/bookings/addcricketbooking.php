            ...
            <form class="addbooking" action="..\..\controller\CRUD.php" method="post" autocomplete="on" >
              ...
              <div class="submain">
                ...
                <div class="questions">
                  ...
                  <input type="text" name="BookingType" id="type" value="Club Booking" readonly>
                  ...
                  <div class="questions">
                      ...
                      <input type="text" name="Total" class="qtype1" id="Cost" readonly  required>
                  </div><br>
                  ...
                  <div class="questions">
                    <p class=" tips">Please enter between 08.00 a.m and 05.00 p.m</p>
                        ...
                        <input type="time" name="ReservedTime" min="08:00" max="17:00" value="<?php echo date("H:i") ?>"  required>
