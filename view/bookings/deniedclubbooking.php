        ...
        <div class="main" >
            <div class="coverheader">
              ...
              <div class="tableheader">
                    ...
                    <h2>Denied Club and Cricket Booking </h2>
              </div>
            </div><br>
            <div class="covertable">
                <div class="table">
                    <div class="upperbar">
                        ...
                        <form class="searchbar" action="deniedclubbooking.php" method="post">
                    ...
                    <div class="detailtable">
                      <?php
                        ...
                        if(isset($_POST['searchname'])){
                          echo'<iframe src="deniedclubbookingtable.php?CustomerName='.$_POST['clubsearch'].'" name="searchinfo" class="staff"></iframe>';
                        }
                        else{
                          echo '<iframe src="deniedclubbookingtable.php" name="searchinfo" class="staff"></iframe>';
                        }
