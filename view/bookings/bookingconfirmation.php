        ...
        <div class="main" >
            <div class="coverheader">
              ...
              <div class="tableheader">
                    ...
                    <h2>Confirmed Club and Cricket Booking </h2>
              </div>
            </div><br>
            <div class="covertable">
                <div class="table">
                    <div class="upperbar">
                        ...
                        <form class="searchbar" action="bookingconfirmation.php" method="post">
                    ...
                    <div class="detailtable">
                      <?php
                        ...
                        if(isset($_POST['searchname'])){
                          echo'<iframe src="clubconfirmationtable.php?CustomerName='.$_POST['clubsearch'].'" name="searchinfo" class="staff"></iframe>';
                        }
                        else{
                          echo '<iframe src="clubconfirmationtable.php" name="searchinfo" class="staff"></iframe>';
                        }
