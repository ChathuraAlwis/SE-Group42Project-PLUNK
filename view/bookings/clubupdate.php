            ...
            <form class="addbookingtwo" action=""  method="post" autocomplete="on" >
                ...
                <div class="line3">
                  ...
                  elseif ($result['permission']=='Denied') {?>
                    <button type="submit" name="button" class="Payment" formaction="..\bookings\clubdeniedpayment.html" ><b>Payment</b> </button><?php }else { ?>
                      <button type="submit" name="button" class="Payment" formaction="..\bookings\clubnodecisionpayment.html" ><b>Payment</b> </button> <?php } ?>
