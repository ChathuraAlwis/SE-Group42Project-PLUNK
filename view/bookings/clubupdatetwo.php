...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    date_default_timezone_set("Asia/Colombo");
        ...
        $today=date("Y-m-d");
        $reservedday=$result['ReservedDate'];

        for ($i=0; $i <2 ; $i++) {
          $today++;
        }
        $targetday =$today;
        if ($targetday>$reservedday) {
          echo "<div class='msg'><h2 class='unablemsg'>Unable to update or delete</h2></div>";
    ...
    ?>
        <div class="main" >
            ...
            <form class="addbooking" action="..\..\controller\CRUD.php" method="post" autocomplete="on" >
              <input name ="update-clubbooking" type="hidden" >
              <div class="headerrow">
                <div class="bin">
                ...
                <div class="submain">
                  ...
                  <div class="questions">
                    ...
                    <div class="questions">
                        ...
                        <input type="number" name="Total" class="qtype1" id="Cost" value="<?php echo "$result[Total]";?>" required>
                    </div><br>
                    <div class="questions">
                    ...
                    <div class="questions">
                          ...
                          <input type="number" name="NoOfPeaople" min="1"  class="qtype1" value="<?php echo "$result[NoOfPeople]";?>" required>
                    </div><br>
                    <div class="questions">
