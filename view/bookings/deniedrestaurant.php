        ...
        <div class="main" >
            <div class="coverheader">
              ...
              <div class="tableheader">
                    ...
                    <h2>Denied Restaurant Booking </h2>
              </div>
            </div><br>
            <div class="covertable">
                <div class="table">
                    <div class="upperbar">
                        ...
                        <form class="searchbar" action="deniedrestaurant.php" method="post">
                    ...
                    <div class="detailtable">
                      <?php
                        ...
                        if(isset($_POST['searchname'])){
                          echo'<iframe src="deniedrestauranttable.php?CustomerName='.$_POST['clubsearch'].'" name="searchinfo" class="staff"></iframe>';
                        }
                        else{
                          echo '<iframe src="deniedrestauranttable.php" name="searchinfo" class="staff"></iframe>';
                        }
