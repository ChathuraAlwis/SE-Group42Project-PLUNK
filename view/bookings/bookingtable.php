                    ...
                    <div class="detailtable">
                      <?php
                          ...
                          elseif ($_SESSION['UserType'] == 'Life Member' || $_SESSION['UserType'] == 'Ordinary Member' || $_SESSION['UserType'] == 'HL Member') {
                            $bookingTable->show("SELECT BookingID as 'ID', BookingType as 'Booking Type',  Reservation1 as 'Reservation 1',Reservation2 as 'Reservation 2', NoOfPeople as 'No. Of People', ReservedDate as Date, ReservedTime as 'From', EndTime as 'To', Total as Payment FROM plunk.booking WHERE UserID=$_SESSION[UserID]", 'updatecm');
                          }
                          else{
