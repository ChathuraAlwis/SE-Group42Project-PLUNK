                            ...
                            if($_SESSION['UserType'] == 'Manager'){?>
                              ...
                              <?php }
                                 ...
                                 $nonotpaid= count($paidslot);
                                  ...
                                  if (isset($_POST['check'])) {
                                    $DB = new DB;
                                  $notpaid="SELECT BookingID FROM plunk.booking WHERE BookingType ='Club' AND (permission='Confirmed' OR permission='No Decision') AND Payment='No'AND UserID= '$_SESSION[UserID]'";
                                  $paidslot=$DB->runQuery($notpaid);
                                  $nonotpaid= count($paidslot);
