...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class= "left">
    <div class="form">
        <h2 class="center-text"><b>New Service Charge Sheet</b></h2>
        <form action="../../controller/CRUD.php" method="POST">
                ...
                <tr>
                    <div class="form-group">
                        <td><label for="WorkingDays">No Of Working Days</label></td>
                        <td><input type="number" id= "WorkingDays" name="WorkingDays" required class="form-control" placeholder="Enter the working days"/></td>
                    </div>
                </tr>
                <tr><td><br></td></tr>
            </table>
