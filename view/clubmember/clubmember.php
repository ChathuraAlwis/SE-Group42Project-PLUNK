    ...
    <div class="main">
          ...
          <div class="header" id="myheader">
                  <div class="leftheader">
                      ...
                      <div class="menudiv">
                         <a href="navbtn.html" class="menubtn" target="navigation"><button type="button" name="Menu" class="Menu" onclick=myFunction() ><box-icon name='menu' animation='tada' color=#0b7fab ></box-icon></button></a>
                      </div>
                  </div>
              ...
              <div class="middle">
                    ...
                    <div class="mainpages" id="mainpages">
                            ...
                            <iframe src="..\Dashboards\cmDashboard.html" class="page" name="Pages"  title="Iframe for pages"></iframe>
